import { icon, escapeHtml, moduleUrl, lessonUrl, labUrl } from "./ui.js";
...
export function renderLesson(
  ...
  // Lesson tables scroll on narrow screens; keyboard readers need the same access.
  container.querySelectorAll(".lesson-section table").forEach((table) => {
    table.tabIndex = 0;
  });
